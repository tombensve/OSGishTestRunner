 ...
 */
public class OTRServiceReference implements ServiceReference {
    //
    // Private Members
    //

    private OTRBundleContext bundleContext;
    ...
    OTRServiceReference( OTRBundleContext bundleContext, Dictionary props) {
